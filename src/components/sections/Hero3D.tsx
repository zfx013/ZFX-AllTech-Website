...
const itemVariants = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.7,
      ease: [0.25, 0.46, 0.45, 0.94] as [number, number, number, number], // Custom cubic-bezier for premium feel
    },
  },
};
  ...
  const LoadingFallback = useMemo(
    () => (
      <div className="absolute inset-0 bg-dark-950" aria-hidden="true">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-600/15 rounded-full blur-[80px] animate-pulse"
          style={{ animationDuration: '4s', animationDelay: '0.75s' }}
        />
      </div>
    ),
    []
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 container-custom py-24 sm:py-28 lg:py-32"
      >
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-violet-500/10 border border-violet-500/25 mb-8 backdrop-blur-md shadow-lg shadow-violet-500/5"
            >
            ...
            <motion.h1
              variants={itemVariants}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] mb-6 lg:mb-8 tracking-tight"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-base sm:text-lg lg:text-xl text-dark-300 max-w-xl mx-auto lg:mx-0 mb-8 lg:mb-10 leading-relaxed"
            >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-wrap gap-6 sm:gap-8 lg:gap-10 mt-12 lg:mt-14 pt-8 lg:pt-10 border-t border-dark-800/50 justify-center lg:justify-start"
              role="list"
            ...
            >
              {STATS_DATA.map((stat) => (
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm text-dark-400 font-medium tracking-wide">
                    {stat.label}
                  </div>
                </div>
              ))}
